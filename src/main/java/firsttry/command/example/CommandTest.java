package firsttry.command.example;

import firsttry.command.example.imp.RestartCommand;
import firsttry.command.example.imp.ShutDownCommand;

/**
 * 通过switch把 client和receiver解耦，1）invoker就是switch，2）receiver就是computer,3）client是用户，4）firsttry.command
 *
