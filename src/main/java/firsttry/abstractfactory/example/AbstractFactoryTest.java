package firsttry.abstractfactory.example;

import firsttry.abstractfactory.example.amd.AMDFactory;
import firsttry.abstractfactory.example.intel.IntelFactory;
 ...
 * Abstract Factory is a super-firsttry.factory which creates other factories. We can call it "Factory of factories".
 *
 *
 * 工厂和抽象工厂的区别：
 * 工厂大熔炉，什么都造，男人女人都造
